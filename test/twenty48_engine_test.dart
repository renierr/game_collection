...
import 'package:game_collection/games/twenty48/engine/twenty48_engine.dart';
import 'package:game_collection/games/twenty48/engine/twenty48_store.dart';
...
void main() {
  ...
  test('sliding merges a matching pair once and scores it', () async {
    ...
    expect(engine.move(GameDirection.left), isTrue);
  ...
  test('a move that changes nothing is refused', () async {
    ...
    expect(engine.move(GameDirection.left), isFalse);
