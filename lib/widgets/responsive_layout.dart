...
class Breakpoints {
  ...
  /// Width past which a single column of text or rows stops reading well and
...
extension ResponsiveConstraints on BoxConstraints {
  ...
  /// Whether the box is wider than it is tall — the question a game board asks
  /// when deciding which side its HUD goes on.
