...
///
/// Wrap the scrollable, not the rows — capping each row would strand the
/// scrollbar at the far edge.
class ReadableWidth extends StatelessWidget {
  final Widget child;

  /// Overrides [Breakpoints.readableContent] for content that reads well wider
  /// (a table) or narrower (a settings column).
