...
/// and the view rebuilds from [ChangeNotifier]. That is the whole reason this
/// game exists in the collection — it proves the architecture is not built
/// only for a 60 Hz painter.
class Twenty48Engine extends ChangeNotifier {
  ...
  bool _slide(GameDirection direction) {
    var moved = false;
  ...
  List<List<int>> _linesFacing(GameDirection direction) {
